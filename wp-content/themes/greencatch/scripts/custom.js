	$(function(){	
		...
		$("iframe[name=weiboshow]").attr('src','http://widget.weibo.com/weiboshow/index.php?language=zh_cn&width=0&height='+(screenHeight+35)+'&fansRow=2&ptype=1&speed=0&skin=10&isTitle=0&noborder=0&isWeibo=1&isFans=0&uid=1998313531&verifier=05eec98a&dpc=1');
